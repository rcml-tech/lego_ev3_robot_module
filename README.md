...
-------------------------------
Данный модуль позволяет программировать **Lego** роботов на RCML, оснащенных **Lego модулем EV3 или NXT**. Программа на RCML исполняется на ПК, связь с EV3 или NXT осуществляется через **Bluetooth**.<br>
...
*Для обращения к моторам A,B,C используются буквы "A","B" и "C" соответственно.<br>*
