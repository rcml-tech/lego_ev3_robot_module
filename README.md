...
-------------------------------
Данный модули позволяют программировать **Lego** роботов на RCML, работающих под управлением **Lego блока EV3**. Программа на RCML исполняется на ПК, связь с EV3 осуществляется через **Bluetooth**.<br>
