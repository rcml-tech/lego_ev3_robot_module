...
Так же в конфигурационном файле в разделе options можно указать разрешено ли динамическое подключение роботов. По умолчанию будет присвоено значение false.
